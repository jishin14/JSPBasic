...
<body>
	...
	<!-- form태그는 사용자가 입력한 값을, 서버(우리 프로젝트)에 전송할 때 사용됩니다 -->
	<!-- form안에 input태그는 name속성을 지정하게 되는데, name은 서버에서 찾아쓰는 이름이 됩니다. -->
	<form action="req_quiz_ok.jsp" method="post">
		...
		전공분야: <input type="radio" name="major" value="경영"/>경영학과
		...
		입사일: <input type="date" name="regdate"/>
		<br/>
